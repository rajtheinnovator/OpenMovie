...
object MoviesRepositoryWithoutPagedList {

    private val _movieDetails = MutableLiveData<MovieDetail>()
    var application: Application? = null
    var moviesRepositoryWithoutPagedList: MoviesRepositoryWithoutPagedList? = null
    ...
    */
    ...
    fun getInstance(application: Application): MoviesRepositoryWithoutPagedList {
        this.application = application
        if (moviesRepositoryWithoutPagedList == null) {
            moviesRepositoryWithoutPagedList = this
        ...
        return moviesRepositoryWithoutPagedList!!
    }
